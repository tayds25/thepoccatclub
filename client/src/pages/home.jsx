...
import totebagImage from "../assets/totebag.png";
import announceImage from "../assets/announce.png";
        ...
        <div className="container mx-auto px-4 py-16">
            <div className="flex min-h-48 gap-8">
                <div className="flex w-1/2 h-80 px-8 place-content-center ml-20">
                    <img className="rounded-md w-full object-cover" src={totebagImage} />
                </div>
                <div className="flex w-1/3 flex-col px-5 justify-between">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-justify text-xl">POC Cat Club or the Philippine Orthopedic Center Cat Club is a dedicated non-profit organization based in Metro Manila, committed to rescuing, nurturing, and finding loving homes for cats in need.</p>
                    </div>
                </div>
            </div>
